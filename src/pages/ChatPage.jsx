...
const ChatPage = () => {
  const {
    ...
    lastScoreChange, lastFeedback, getNextAssistantPrompt
  } = useChatLogic();
  ...
  return (
    <div className="flex h-screen bg-chatbg">
      ...
      <ChatArea
        ...
        getNextAssistantPrompt={getNextAssistantPrompt}
      />
    </div>
  );
};

const ChatArea = ({ selectedRole, apiKey, setApiKey, systemMessage, setSystemMessage, conversations, currentConversationIndex, isStreaming, getRoleName, scrollAreaRef, input, setInput, handleSubmit, handleVoiceInput, score, lastScoreChange, lastFeedback, getNextAssistantPrompt }) => (
    ...
    <div className="p-4 bg-white border-t shadow-md">
      <form onSubmit={handleSubmit} className="flex gap-2">
        <Input
          ...
          placeholder={getNextAssistantPrompt() || "Type your message..."}
          className="flex-grow"
